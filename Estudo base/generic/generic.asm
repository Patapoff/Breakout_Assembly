...
.Const
	...
	ID_TIMER  EQU 1
	TIMER_MAX EQU 100 ;; tempo em milisegundos
...
; -------------------------------------------------------------------------
    ...
    ;======== menu commands ========
        ...
        .elseif wParam == 1900
            szText TheMsg,"Assembler Rule´s turma"
...
Paint_Proc proc hWin:DWORD, hDC:DWORD
	...
	invoke BitBlt, hDC, 100,10, 168,66, memDC, 0, 0, SRCCOPY
	...
	invoke BitBlt, hDC, 10,10, 32,32, memDC, 0, 0, SRCCOPY
	invoke BitBlt, hDC, 42,10, 32,32, memDC, 0, 320, SRCCOPY
	
	invoke TransparentBlt,hDC,posX,10,32,32,memDC,0,256,32,32, CREF_TRANSPARENT 
